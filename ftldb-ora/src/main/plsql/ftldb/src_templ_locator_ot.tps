 ...
 * optionally within a non-compiled PLSQLCC section or a named section bounded
 * by special comment lines.
 *
 * The template name may start with 'src:' prefix. It may be any valid Oracle
 * function, procedure, package, type, trigger, view or java (re)source name. It
