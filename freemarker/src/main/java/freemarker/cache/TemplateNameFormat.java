 ...
 * Copyright 2015 Victor Osolovskiy, Sergey Navrotskiy
 *
...
public abstract class TemplateNameFormat {
    ...
    public static final TemplateNameFormat FTLDB_NAME_FORMAT = new FTLDBNameFormat();

    private static final class FTLDBNameFormat extends TemplateNameFormat {

        String toAbsoluteName(String baseName, String targetName) throws MalformedTemplateNameException {
            if (baseName == null || !targetName.startsWith("@@") || !baseName.startsWith("@")) {
                return targetName;
            }
            ...
            return (baseName.endsWith("/")
                        ...
                        : (baseName.lastIndexOf("/") != -1
                            ...
                            : "@"))
                    + targetName.replaceFirst("^@+", "");
        }

        String normalizeAbsoluteName(String name) throws MalformedTemplateNameException {
            if (!name.startsWith("@")) return name;

            return "@" + DEFAULT_2_4_0.normalizeAbsoluteName(name.replaceFirst("^@+", ""));
        }

        public String toString() {
            return "TemplateNameFormat.FTLDB_NAME_FORMAT";
        }
