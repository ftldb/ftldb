 ...
 * @param  in_indent  the indent size (optional)
 */
procedure put(
 ...
 *
 * Optionally deletes spaces at the boundaries of each CLOB and places
 ...
 * @param  in_refine_spaces  if true does some formatting (needed for scripts)
 ...
 *
 * @param  in_clob         the CLOB locator
 * @param  in_delim        the delimiter
 * @param  in_trim_spaces  if true trims spaces from both sides of each piece
